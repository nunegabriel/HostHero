          ...
          <div class="row justify-content-center" style="padding:30px">
            <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title">Captaincy Picks</h5>
                  <p class="card-text" style="color:rgb(35, 2, 55)">Lorem, ipsum dolor sit amet consectetur adipisicing
                    ...
                    <a href ="{{ route('col1') }}" class="btn btn-primary">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title" style="color:rgb(35, 2, 55)">Low-Budget</h5>
                  <p class="card-text" style="color:rgb(35, 2, 55)">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
                  <a href ="{{ route('col2') }}" class="btn btn-primary">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title" style="color:rgb(35, 2, 55)">Injury Updates</h5>
                  <p class="card-text" style="color:rgb(35, 2, 55)">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
                  <a href= "{{ route('col3') }}" class="btn btn-primary">Read More</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row justify-content-center" style="padding:30px">
            <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title" style="color:rgb(35, 2, 55)">Clean Sheet Kings</h5>
                  <p class="card-text" style="color:rgb(35, 2, 55)">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
                  <a href="{{ route('col4') }}" class="btn btn-primary">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title" style="color:rgb(35, 2, 55)">Shot Stopper</h5>
                  <p class="card-text" style="color:rgb(35, 2, 55)">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
            ...
            <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title" style="color:rgb(35, 2, 55)">Players to own</h5>
                  <p class="card-text" style="color:rgb(35, 2, 55)">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
