...
<body>
    ...
    <div class="container">
      <div class="row align-items-center" style="color:beige">
        <div class="col-lg-5">
          ...
          <p class="lead" style="color:rgb(248, 244, 250)">Fantasy Boost gives you team news, injury updates, gameweek
  ...
  <div class="container mt-5" style=" padding: 0.1px">
    <div class="row d-flex justify-content-center">
      <div class="col-lg-12">
        <div class="card mb-5" style="margin-top: -130px; background-color: rgb(235, 239, 241);">
          <div class="card-body text-center" style="background-color: rgb(235, 239, 241);">
            <h1 class="mb-4 fw-bold" style="color:rgb(3, 14, 48); padding:20px; ">GAMEWEEK 20</h1>
          ...
          <div class="row justify-content-center" style="padding:30px">
            <!-- <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title fw-bold" style="color:rgb(3, 14, 48)">Captaincy Picks</h5>
            ...
            <!-- <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title fw-bold" style="color:rgb(3, 14, 48)">Low-Budget</h5>
                  <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
            ...
            <!-- <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title fw-bold" style="color:rgb(3, 14, 48)">Injury Updates</h5>
                  <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
          ...
          <div class="row justify-content-center" style="padding:30px">
            <!-- <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title fw-bold" style="color:rgb(3, 14, 48)">Clean Sheet Kings</h5>
                  <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
            ...
            <!-- <div class="col-md-4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <h5 class="card-title fw-bold" style="color:rgb(3, 14, 48)">Players to own</h5>
                  <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing
                    elit.
                    Labore assumenda aut officiis ipsum accusantium unde
                    reiciendis eos aspern</p>
          ...
          <div class="container">
            <div class="card" style="padding:30px;">
              <h1 class="mb-4 d-flex justify-content-center fw-bold" style="color:rgb(3, 14, 48)">GAMEWEEK 21 SQUAD </h1>
              <div class="row">
                <div class="col-md-8">
